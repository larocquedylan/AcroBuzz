...
let PostResolver = class PostResolver {
    ...
    post(id, { em }) {
        return em.findOne(Posts_1.Post, { _id: id });
    }
    async createPost(title, { em }) {
        const post = em.create(Posts_1.Post, {
            title,
            createdAt: '',
            updatedAt: '',
        });
    ...
    async updatePost(id, title, { em }) {
        const post = await em.findOne(Posts_1.Post, { _id: id });
        if (!post) {
            return null;
        }
    ...
    async deletePost(id, { em }) {
        await em.nativeDelete(Posts_1.Post, { _id: id });
        return true;
    }
};
__decorate([
